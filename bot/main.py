...
# mongoDB Client
link = f'mongodb+srv://{MONGO_TEARS}:{MONGO_TEARS_PASS}@cluster0.nff6w.mongodb.net/users_db?retryWrites=true&w=majority'
...
async def on_message(message):
	...
	if message.author == client.user:
		...
		elif message.content.startswith('hi') or message.content.startswith('hey'):
